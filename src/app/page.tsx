        ...
        <nav className="navbar">
          ...
          <div className="logo-container">
            ...
            <div className="logo-text-wrapper">
              <a
                href="https://share.google/Hkuf9AIgf7jVN6dC9"
                target="_blank"
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <div className="badge-serving">
            ...
            Serving Greater New Orleans Since 2015
          </div>
          ...
          <p className="hero-subtitle">
            Landscape design, hardscape, lighting and turf <br />
      ...
      <section className="why-section">
        <div className="why-header">
          <div className="why-tag">
            ...
            Why Choose <a href="https://share.google/Hkuf9AIgf7jVN6dC9" target="_blank" rel="noopener noreferrer">Eric&apos;s Tidy Turf</a>
          </div>
...
const REVIEWS = [
  ...
  },
  {
    ...
    text: (
      <>
        “Had <a href="https://share.google/Hkuf9AIgf7jVN6dC9" target="_blank" rel="noopener noreferrer" style={{ textDecoration: "underline", color: "inherit", fontWeight: "bold" }}>Eric's Tidy Turf</a> update our front yard landscape. Awesome job!! Definitely the company to get the work done.”
      </>
    ),
    name: "Keith Savoie",
  ...
  },
  {
    ...
    text: (
      <>
        “<a href="https://share.google/Hkuf9AIgf7jVN6dC9" target="_blank" rel="noopener noreferrer" style={{ textDecoration: "underline", color: "inherit", fontWeight: "bold" }}>Eric’s Tidy Turf Landscaping</a> delivered absolutely outstanding 5-star service from start to finish. Eric was professional, punctual, and paid attention to every detail. The quality of the work exceeded expectations, and the yard has never looked better. Communication was excellent throughout the entire process, and it’s clear they truly care about customer satisfaction and taking pride in their work. If you’re looking for reliable, high-quality landscaping services, I highly recommend <a href="https://share.google/Hkuf9AIgf7jVN6dC9" target="_blank" rel="noopener noreferrer" style={{ textDecoration: "underline", color: "inherit", fontWeight: "bold" }}>Eric’s Tidy Turf Landscaping</a>!”
      </>
    ),
    name: "Ryan Hunter",
    meta: "2 months ago",
