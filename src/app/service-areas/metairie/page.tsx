...
export const metadata = {
  title: "Landscaping in Metairie, LA | Eric's Tidy Turf",
  description: "Professional landscaping and outdoor installations in Metairie, LA. High-quality services across Greater New Orleans."
};

export default function MetairiePage() {
  const otherAreas = [
      ...
      <section className="process-section" style={{ background: "radial-gradient(circle at 80% 20%, #1c451e 0%, var(--color-dark) 100%)", color: "#ffffff", padding: "9rem 2rem 5.5rem 2rem" }}>
        <div style={{ maxWidth: "var(--max-width)", margin: "0 auto" }} className="animate-fade-in-up">
          ...
          <p style={{ fontSize: "1.25rem", color: "rgba(255, 255, 255, 0.8)", maxWidth: "700px", lineHeight: "1.6", marginBottom: "2.5rem" }}>
            Professional landscaping and outdoor installations in Metairie, LA. Contact <a href="https://share.google/Hkuf9AIgf7jVN6dC9" target="_blank" rel="noopener noreferrer" style={{ textDecoration: "underline", color: "inherit", fontWeight: "bold" }}>Eric’s Tidy Turf Landscaping</a> for professional outdoor services.
          </p>
      ...
      <section className="area-section">
        <div className="area-container animate-fade-in-up">
          ...
          <div className="area-map-wrapper" style={{ boxShadow: "0 25px 50px rgba(25, 61, 27, 0.08)" }}>
            <iframe
              title="Erics Tidy Turf Metairie Service Area Map"
              src="https://www.google.com/maps?q=Metairie,+LA&z=12&output=embed"
      ...
      <section className="faq-section" style={{ backgroundColor: "#faf9f6" }}>
        <div style={{ maxWidth: "var(--max-width)", margin: "0 auto", padding: "0 2rem" }}>
          <div className="faq-header" style={{ textAlign: "center", marginBottom: "4rem" }}>
            ...
            <h2 className="faq-heading" style={{ fontSize: "3rem" }}>Services Available in Metairie</h2>
          </div>
