...
export const metadata = {
  title: "Landscaping in St. Tammany Parish, LA | Eric's Tidy Turf",
  description: "Professional landscaping and outdoor installations in St. Tammany Parish, LA. High-quality services across Greater New Orleans and surrounding areas."
};

export default function StTammanyParishPage() {
  const otherAreas = [
      ...
      <section className="area-section">
        <div className="area-container animate-fade-in-up">
          ...
          <div className="area-map-wrapper" style={{ boxShadow: "0 25px 50px rgba(25, 61, 27, 0.08)" }}>
            <iframe
              title="Erics Tidy Turf St. Tammany Parish Service Area Map"
      ...
      <section className="faq-section" style={{ backgroundColor: "#faf9f6" }}>
        <div style={{ maxWidth: "var(--max-width)", margin: "0 auto", padding: "0 2rem" }}>
          <div className="faq-header" style={{ textAlign: "center", marginBottom: "4rem" }}>
            ...
            <h2 className="faq-heading" style={{ fontSize: "3rem" }}>Services Available in St. Tammany Parish</h2>
          </div>
